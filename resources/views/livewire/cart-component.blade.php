<main id="main" class="main-site">
    ...
    <div class="container">
        ...
        <div class=" main-content-area">
                ...
                <ul class="products-cart">
                    ...
                    <li class="pr-cart-item">
                        <div class="product-image">
                            <figure>
                                <img src="{{asset('assets/images/products')}}/{{$cart->model->image}}" 
                                alt="{{$cart->model->name}}">
                            </figure>
                        </div>
                        <div class="product-name">
                            <a class="link-to-product"
                             href="{{route('product.details', ['slug' => $cart->model->slug])}}">{{$cart->model->name}}
                            </a>
                        </div>
                        <div class="price-field produtc-price">
                            <p class="price">{{$cart->model->regular_price}}$</p>
                        </div>
                        <div class="quantity">
                            <div class="quantity-input">
                                <input type="text" name="product-quatity" value="{{$cart->qty}}" data-max="120" pattern="[0-9]*" >									
                                <a class="btn btn-increase" href="#" 
                                wire:click.prevent="increaseCartQuantity('{{$cart->rowId}}')">
                            </a>
                                <a class="btn btn-reduce" href="#" 
                                wire:click.prevent="decreaseCartQuantity('{{$cart->rowId}}')">
                            </a>
                            </div>
                            <p class="text-center">
                                <a href="#" wire:click.prevent="switchToSaveForLater('{{$cart->rowId}}')">
                                    Save for Later
                                </a>
                            </p>
                        </div>
                        ...
                        <div class="delete">
                            <a href="#" wire:click.prevent="destroyCartItem('{{$cart->rowId}}')"
            ...
            <div class="summary">
                <div class="order-summary">
                    ...
                    <p class="summary-info">
                        ...
                        <b class="index">{{Cart::instance('addtocart')->subtotal()}}$</b>
                    </p>
                    ...
                    <p class="summary-info total-info ">
                        ...
                        @else
                            <p class="summary-info">
                                ...
                                <b class="index">{{Cart::instance('addtocart')->tax()}}$</b>
                            </p>
                            <p class="summary-info">
                            ...
                            <p class="summary-info total-info ">
                                <span class="title">Total</span>
                                <b class="index">{{Cart::instance('addtocart')->total()}}$</b>
                            </p>
                    @endif
                </div>
            ...
            <div class="checkout-info">
                ...
                <label class="checkbox-field">
                    <input class="frm-input " wire:model="haveCouponeCode"
                    name="have-code" id="have-code" value="1" type="checkbox">
                    <span>I have coupon code</span>
                </label>
                @if ($haveCouponeCode == 1)
                    <div class="summary-item">
                        <form wire:submit.prevent="applyCouponeCode">
                            ...
                            <p class="row-in-form">
                                ...
                                <input type="text" name="coupon-code" wire:model="couponeCode"/>
                            </p>
        ...
        <a class="link-to-shop" href="shop.html">Continue Shopping<i class="fa fa-arrow-circle-right" aria-hidden="true"></i></a>
            ...
            <div class="wrap-iten-in-cart" id="saveForLater">
                ...
                <ul class="products-cart">
                    ...
                    <li class="pr-cart-item">
                        ...
                        <div class="quantity">
                            <p class="text-center">
                                <a href="#" wire:click.prevent="moveToCart('{{$cart->rowId}}')">
                                    Move To Cart
                                </a>
                            </p>
                        </div>
                        <div class="delete">
                            <a href="#" wire:click.prevent="deleteFromSaveForLater('{{$cart->rowId}}')"
                             class="btn btn-delete" title="">
