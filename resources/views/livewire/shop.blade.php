                    ...
                    <div class="wrap-right">
                        ...
                        <div class="sort-item orderby ">
                            <select name="orderby" class="use-chosen" wire:model="sorting">
                                ...
                                <option value="date">Sort by newnest</option>
                                <option value="low_to_high_price">Sort by price: low to high</option>
                                <option value="high_to_low_price">Sort by price: high to low</option>
                            </select>
                        </div>

                        <div class="sort-item product-per-page">
                            <select name="post-per-page" class="use-chosen" wire:model="productPerPage">
                        ...
                        <li class="col-lg-4 col-md-6 col-sm-6 col-xs-6 ">
                            <div class="product product-style-3 equal-elem ">
                                ...
                                <div class="product-wish">
                                    ...
                                    <a href="#" wire:click.prevent="removeProductFromWishlist({{$product->id}})">
