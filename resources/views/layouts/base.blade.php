	...
	@if(Route::has('login'))
		...
		<a title="My Account" href="#">My Account ({{Auth::user()->name}})<i class="fa fa-angle-down" aria-hidden="true"></i></a>
			<ul class="submenu curency" >
				...
				<li class="menu-item" >
					<a title="Manage Home Sliders" href="{{route('admin.homeslider')}}">Manage Home Sliders</a>
				</li>
				<li class="menu-item" >
					<a title="Manage Home Categories" href="{{route('admin.homecategories')}}">Manage Home Categories</a>
				</li>
				<li class="menu-item" >
					<a title="Manage Home OnSale" href="{{route('admin.onsale')}}">Manage Home OnSale</a>
				</li>
				<li class="menu-item" >
...
<div class="nav-section header-sticky">
	...
	<script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datetimepicker/4.17.47/js/bootstrap-datetimepicker.min.js"
	 ...
	 <script src="https://cdn.tiny.cloud/1/ldcjte5vik6z06b8wo3rp856lythtztbw3l1fvu6hrtfmv69/tinymce/5/tinymce.min.js"
